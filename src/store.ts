...
export const defaultCameraPosition: AssemblyVector3 = [50, 50, 50];
export const defaultControlsTarget: AssemblyVector3 = [0, 0, 0];
export const cameraPosition = ref<AssemblyVector3>([...defaultCameraPosition]);
export const controlsTarget = ref<AssemblyVector3>([...defaultControlsTarget]);
